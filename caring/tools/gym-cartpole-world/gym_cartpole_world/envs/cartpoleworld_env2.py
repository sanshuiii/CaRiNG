...
class CartPoleWorldEnv2(gym.Env):
    metadata = {
        'render.modes': ['human', 'rgb_array'],
        'video.frames_per_second': 50
    }

    def __init__(self, case=1, gravity=9.8, masscart=1.0, polelen=0.5):
        ...
        self.theta_threshold_max = 60
        self.x_threshold_max = 8

        self.theta_threshold2 = 45
        self.x_threshold2 = 5
    ...
    def initialize(self, theta_threshold=60, x_threshold=8):
        ...
        self.theta_threshold_radians2 = self.theta_threshold2 * 2 * math.pi / 360
    ...
    def _step(self, action):
        ...
        done2 = x < -self.x_threshold2 \
                or x > self.x_threshold2 \
                or theta < -self.theta_threshold_radians2 \
                or theta > self.theta_threshold_radians2
        done2 = bool(done2)
    ...
    def _render(self, mode='human', close=False):
        ...
        # world_width = (self.x_threshold_max +
        #                np.maximum(cartwidth/2, polelen * np.sin(theta_threshold_radians_max))
        #                ) * 2
        ...
        # print('world_width {}, scale {}'.format(world_width, scale))
        ...
        # cartx = x[0] * 125 + screen_width / 2.0  # MIDDLE OF CART
